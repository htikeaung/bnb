...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('B&B Bar & Billiard'),
      ...
      body: WebView(
        // initialUrl: 'http://192.168.8.100/software',
        // initialUrl: 'http://192.168.123.200/software', // local
        // initialUrl: 'https://tysolutionsmm.com/restaurantsoftware/', // Dev
        initialUrl: 'https://bnb-myanmar.com/', // Live
